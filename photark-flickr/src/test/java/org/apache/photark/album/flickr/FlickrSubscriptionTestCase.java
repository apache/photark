...
public class FlickrSubscriptionTestCase {
    ...
    public static void BeforeClass() {
        photoStream = new FlickrPhotoStream("http://api.flickr.com/services/feeds/photos_public.gne?id=24662369@N07&lang=en-us&format=atom");
    }
    ...
    public void testDiscoverAlbums() {
        ...
        for(Entry<String, Image> image : images) {
            System.out.println(">>>" + image.getData().getName());
        }
    }
}
