...
public class AppDataManagerImpl implements AppDataManager {
    ...
    public Map<String, Map<String, String>> getPeopleData(String[] userIds, String groupId) throws PhotArkSocialException {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    public void updatePersonData(String userId, String groupId, String appId, Set<String> fields, Map<String, String> values)
